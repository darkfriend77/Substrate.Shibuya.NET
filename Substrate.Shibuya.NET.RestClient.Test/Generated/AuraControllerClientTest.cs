...
namespace Substrate.Shibuya.NET.RestClient.Test.Generated
{
   ...
   public class AuraControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetTestValue6()
      {
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot result;
         result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot();
      ...
      public async System.Threading.Tasks.Task TestCurrentSlot()
      {
         ...
         // Construct new RPC client to test with.
         AuraControllerClient rpcClient = new AuraControllerClient(_httpClient, subscriptionClient);
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot mockupValue = this.GetTestValue6();
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot rpcResult = await rpcClient.GetCurrentSlot();
