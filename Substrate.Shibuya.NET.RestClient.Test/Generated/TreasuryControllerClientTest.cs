...
namespace Substrate.Shibuya.NET.RestClient.Test.Generated
{
   ...
   using Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury;
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result;
         result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal();
         result.Proposer = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);
      ...
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 GetTestValue8()
      {
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 result;
         result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26();
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 mockupValue = this.GetTestValue8();
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 rpcResult = await rpcClient.GetApprovals();
