...
namespace Substrate.Shibuya.NET.RestClient.Test.Generated
{
   ...
   using Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue;
   ...
   public class DmpQueueControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData GetTestValue2()
      {
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData result;
         result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData();
         result.MaxIndividual = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
         result.MaxIndividual = this.GetTestValue3();
         return result;
      }
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight GetTestValue3()
      {
      ...
      public async System.Threading.Tasks.Task TestConfiguration()
      {
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData mockupValue = this.GetTestValue2();
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData rpcResult = await rpcClient.GetConfiguration();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData GetTestValue5()
      {
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData result;
         result = new Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData();
      ...
      public async System.Threading.Tasks.Task TestPageIndex()
      {
         ...
         // Construct new RPC client to test with.
         DmpQueueControllerClient rpcClient = new DmpQueueControllerClient(_httpClient, subscriptionClient);
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData mockupValue = this.GetTestValue5();
         ...
         Substrate.Shibuya.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData rpcResult = await rpcClient.GetPageIndex();
