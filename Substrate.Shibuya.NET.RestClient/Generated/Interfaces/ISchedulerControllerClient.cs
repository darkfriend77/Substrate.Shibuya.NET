...
namespace Substrate.Shibuya.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ISchedulerControllerClient
   {
      ...
      Task<BoundedVecT12> GetAgenda(U32 key);
      Task<bool> SubscribeAgenda(U32 key);
      Task<BaseTuple<U32, U32>> GetLookup(Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
      Task<bool> SubscribeLookup(Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
   }
}
