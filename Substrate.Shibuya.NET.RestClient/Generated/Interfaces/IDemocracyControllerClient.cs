...
namespace Substrate.Shibuya.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IDemocracyControllerClient
   {
      ...
      Task<BoundedVecT23> GetPublicProps();
      ...
      Task<EnumVoting> GetVotingOf(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeVotingOf(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<BaseTuple<U32, BoundedVecT10>> GetBlacklist(H256 key);
