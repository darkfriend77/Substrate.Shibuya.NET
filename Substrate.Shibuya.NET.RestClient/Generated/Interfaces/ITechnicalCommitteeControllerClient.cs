...
namespace Substrate.Shibuya.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ITechnicalCommitteeControllerClient
   {
      ...
      Task<EnumRuntimeCall> GetProposalOf(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeProposalOf(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<Votes> GetVoting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeVoting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
