...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TechnicalCommitteeControllerClient : BaseClient, ITechnicalCommitteeControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT25>(_httpClient, "technicalcommittee/proposals");
      }
      ...
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "technicalcommittee/proposalof", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.ProposalOf", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "technicalcommittee/voting", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.Voting", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
