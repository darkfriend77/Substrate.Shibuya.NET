...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmpQueueControllerClient : BaseClient, IXcmpQueueControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/inboundxcmpmessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeInboundXcmpMessages(BaseTuple<Id, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.InboundXcmpMessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/outboundxcmpmessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OutboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeOutboundXcmpMessages(BaseTuple<Id, U16> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.OutboundXcmpMessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OutboundXcmpMessagesParams(key));
      }
      public async Task<BaseVec<U8>> GetSignalMessages(Id key)
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/signalmessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.SignalMessagesParams(key));
      }
      public async Task<bool> SubscribeSignalMessages(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.SignalMessages", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.SignalMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Id, U32, BaseVec<U8>>>(_httpClient, "xcmpqueue/overweight", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
      public async Task<bool> SubscribeOverweight(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.Overweight", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
