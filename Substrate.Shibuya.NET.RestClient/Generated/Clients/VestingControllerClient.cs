...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class VestingControllerClient : BaseClient, IVestingControllerClient
   {
      ...
      public async Task<BoundedVecT16> GetVesting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT16>(_httpClient, "vesting/vesting", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
      public async Task<bool> SubscribeVesting(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Vesting.Vesting", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
