...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TreasuryControllerClient : BaseClient, ITreasuryControllerClient
   {
      ...
      {
         return await SendRequestAsync<Proposal>(_httpClient, "treasury/proposals", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      public async Task<bool> SubscribeProposals(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Proposals", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
