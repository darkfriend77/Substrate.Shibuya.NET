...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class SystemControllerClient : BaseClient, ISystemControllerClient
   {
      ...
      public async Task<AccountInfo> GetAccount(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<AccountInfo>(_httpClient, "system/account", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      public async Task<bool> SubscribeAccount(Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.Account", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      ...
      {
         return await SendRequestAsync<H256>(_httpClient, "system/blockhash", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<bool> SubscribeBlockHash(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.BlockHash", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<BaseVec<U8>> GetExtrinsicData(U32 key)
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "system/extrinsicdata", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      public async Task<bool> SubscribeExtrinsicData(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.ExtrinsicData", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, U32>>>(_httpClient, "system/eventtopics", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
      public async Task<bool> SubscribeEventTopics(H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.EventTopics", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
