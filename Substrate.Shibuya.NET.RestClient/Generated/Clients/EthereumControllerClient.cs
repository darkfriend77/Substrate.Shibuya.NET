...
namespace Substrate.Shibuya.NET.RestClient.Generated.Clients
{
   ...
   public sealed class EthereumControllerClient : BaseClient, IEthereumControllerClient
   {
      ...
      public async Task<BaseVec<BaseTuple<Substrate.Shibuya.NET.NetApiExt.Generated.Model.ethereum.transaction.EnumTransactionV2, TransactionStatus, EnumReceiptV3>>> GetPending()
      {
         return await SendRequestAsync<BaseVec<BaseTuple<Substrate.Shibuya.NET.NetApiExt.Generated.Model.ethereum.transaction.EnumTransactionV2, TransactionStatus, EnumReceiptV3>>>(_httpClient, "ethereum/pending");
      }
      ...
      {
         return await SendRequestAsync<H256>(_httpClient, "ethereum/blockhash", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.EthereumStorage.BlockHashParams(key));
      }
      public async Task<bool> SubscribeBlockHash(U256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Ethereum.BlockHash", Substrate.Shibuya.NET.NetApiExt.Generated.Storage.EthereumStorage.BlockHashParams(key));
      }
   }
}
