...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IDemocracyControllerMockupClient
   {
      ...
      Task<bool> SetPublicProps(BoundedVecT23 value);
      ...
      Task<bool> SetVotingOf(EnumVoting value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SetLastTabledWasExternal(Bool value);
      Task<bool> SetNextExternal(BaseTuple<EnumBounded, EnumVoteThreshold> value);
      Task<bool> SetBlacklist(BaseTuple<U32, BoundedVecT10> value, H256 key);
