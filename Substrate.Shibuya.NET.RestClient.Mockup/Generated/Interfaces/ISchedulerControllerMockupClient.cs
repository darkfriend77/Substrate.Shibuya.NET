...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface ISchedulerControllerMockupClient
   {
      ...
      Task<bool> SetAgenda(BoundedVecT12 value, U32 key);
      Task<bool> SetLookup(BaseTuple<U32, U32> value, Substrate.Shibuya.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
   }
}
