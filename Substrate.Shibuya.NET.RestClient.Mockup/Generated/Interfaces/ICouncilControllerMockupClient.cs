...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface ICouncilControllerMockupClient
   {
      ...
      Task<bool> SetProposalOf(EnumRuntimeCall value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SetVoting(Votes value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
