...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IBalancesControllerMockupClient
   {
      ...
      Task<bool> SetAccount(AccountData value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SetLocks(WeakBoundedVecT2 value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SetReserves(BoundedVecT15 value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
   }
}
