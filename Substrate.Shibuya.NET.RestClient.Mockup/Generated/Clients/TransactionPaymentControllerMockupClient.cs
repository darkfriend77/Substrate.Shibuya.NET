...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TransactionPaymentControllerMockupClient : MockupBaseClient, ITransactionPaymentControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "TransactionPayment/NextFeeMultiplier", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage.NextFeeMultiplierParams());
      }
      public async Task<bool> SetStorageVersion(EnumReleases value)
      {
         return await SendMockupRequestAsync(_httpClient, "TransactionPayment/StorageVersion", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage.StorageVersionParams());
      }
   }
}
