...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TimestampControllerMockupClient : MockupBaseClient, ITimestampControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/Now", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TimestampStorage.NowParams());
      }
      public async Task<bool> SetDidUpdate(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/DidUpdate", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.TimestampStorage.DidUpdateParams());
      }
   }
}
