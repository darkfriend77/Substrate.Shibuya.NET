...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraControllerMockupClient : MockupBaseClient, IAuraControllerMockupClient
   {
      ...
      public async Task<bool> SetAuthorities(BoundedVecT18 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/Authorities", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.AuraStorage.AuthoritiesParams());
      }
      public async Task<bool> SetCurrentSlot(Slot value)
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/CurrentSlot", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.AuraStorage.CurrentSlotParams());
      }
   }
}
