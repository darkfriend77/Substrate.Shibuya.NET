...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class RandomnessCollectiveFlipControllerMockupClient : MockupBaseClient, IRandomnessCollectiveFlipControllerMockupClient
   {
      ...
      public async Task<bool> SetRandomMaterial(BoundedVecT11 value)
      {
         return await SendMockupRequestAsync(_httpClient, "RandomnessCollectiveFlip/RandomMaterial", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.RandomnessCollectiveFlipStorage.RandomMaterialParams());
      }
   }
}
