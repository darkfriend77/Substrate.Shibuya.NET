...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
   }
}
