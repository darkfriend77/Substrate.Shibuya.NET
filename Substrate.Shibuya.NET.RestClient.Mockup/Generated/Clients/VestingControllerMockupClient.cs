...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class VestingControllerMockupClient : MockupBaseClient, IVestingControllerMockupClient
   {
      ...
      public async Task<bool> SetVesting(BoundedVecT16 value, Substrate.Shibuya.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Vesting/Vesting", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
      public async Task<bool> SetStorageVersion(EnumReleases value)
      {
         return await SendMockupRequestAsync(_httpClient, "Vesting/StorageVersion", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.VestingStorage.StorageVersionParams());
      }
   }
}
