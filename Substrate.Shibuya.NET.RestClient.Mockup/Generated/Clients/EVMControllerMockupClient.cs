...
namespace Substrate.Shibuya.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class EVMControllerMockupClient : MockupBaseClient, IEVMControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "EVM/AccountCodes", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.EVMStorage.AccountCodesParams(key));
      }
      public async Task<bool> SetAccountStorages(H256 value, BaseTuple<H160, H256> key)
      {
         return await SendMockupRequestAsync(_httpClient, "EVM/AccountStorages", value.Encode(), Substrate.Shibuya.NET.NetApiExt.Generated.Storage.EVMStorage.AccountStoragesParams(key));
      }
   }
}
